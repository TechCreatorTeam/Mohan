  ...
  const handleRefresh = async () => {
    ...
    try {
      if (fetchOrders) {
        ...
        window.location.reload(); // fallback if no fetchOrders
      }
    } finally {
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <div className="flex space-x-2">
              ...
              <button
                ...
                className={`inline-flex items-center px-3 py-2 border rounded-md text-sm font-medium border-slate-300 dark:border-slate-700 text-slate-700 dark:text-slate-200 bg-white dark:bg-slate-900 hover:bg-slate-50 dark:hover:bg-slate-700 ${
                        ...
                        <td className="px-6 py-4 whitespace-nowrap text-sm text-slate-700 dark:text-slate-300">
                          <div className="flex items-center gap-2 group">
                            ...
                            <button 
                              ...
                              title="Copy Order ID"
                            >
                              <Copy className="h-4 w-4 hover:text-blue-600" />
                            </button>
                          </div>
                        </td>
                        <td className="px-6 py-4 whitespace-nowrap">
